...
interface ExploreBookmarkCardProps {
  id: string;
  title: string;
  slug: string;
...
export function ExploreBookmarkCard({
  id,
  title,
  slug,
  description,
      ...
      <div className="h-48 overflow-hidden rounded-t-xl bg-neutral-300">
        {imageUrl ? (
          ...
          <div className="flex h-full w-full items-center justify-center">
            <span className="text-sm text-neutral-600">Website Preview</span>
          </div>
        )}
      </div>
      <div className="p-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            <button
              onClick={handleLike}
              className={liked ? "text-red-500" : "text-neutral-500 hover:text-red-500"}
            >
