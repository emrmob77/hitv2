  ...
  return (
    <section className="relative overflow-hidden rounded-xl border border-gray-200 bg-gradient-to-br from-blue-50/50 via-white to-purple-50/50 p-8 shadow-sm">
      ...
      <div className="relative">
        ...
        <div className="mt-8 grid grid-cols-2 gap-4 border-t border-gray-200 pt-8 sm:grid-cols-3 lg:grid-cols-6">
          <div className="group rounded-lg border border-gray-200 bg-white p-4 text-center shadow-sm transition-all hover:border-gray-300 hover:shadow">
            <div className="mb-1 text-3xl font-bold text-gray-900">{stats.bookmarks}</div>
            <div className="text-sm font-medium text-gray-600">Bookmarks</div>
          </div>

          <div className="group rounded-lg border border-gray-200 bg-white p-4 text-center shadow-sm transition-all hover:border-gray-300 hover:shadow">
            <div className="mb-1 text-3xl font-bold text-gray-900">{stats.collections}</div>
            <div className="text-sm font-medium text-gray-600">Collections</div>
          </div>

          <div className="group rounded-lg border border-gray-200 bg-white p-4 text-center shadow-sm transition-all hover:border-gray-300 hover:shadow">
            <div className="mb-1 text-3xl font-bold text-gray-900">{stats.followers}</div>
            <div className="text-sm font-medium text-gray-600">Followers</div>
          </div>

          <div className="group rounded-lg border border-gray-200 bg-white p-4 text-center shadow-sm transition-all hover:border-gray-300 hover:shadow">
            <div className="mb-1 text-3xl font-bold text-gray-900">{stats.following}</div>
            <div className="text-sm font-medium text-gray-600">Following</div>
          </div>

          <div className="group rounded-lg border border-gray-200 bg-white p-4 text-center shadow-sm transition-all hover:border-gray-300 hover:shadow">
            <div className="mb-1 text-3xl font-bold text-gray-900">{stats.likes}</div>
            <div className="text-sm font-medium text-gray-600">Total Likes</div>
          </div>

          <div className="group rounded-lg border border-gray-200 bg-white p-4 text-center shadow-sm transition-all hover:border-gray-300 hover:shadow">
            <div className="mb-1 text-3xl font-bold text-gray-900">{stats.subscribers}</div>
            <div className="text-sm font-medium text-gray-600">Subscribers</div>
          </div>
          {stats.premiumPosts > 0 && (
            <div className="group rounded-lg border border-gray-200 bg-white p-4 text-center shadow-sm transition-all hover:border-gray-300 hover:shadow">
              <div className="mb-1 text-3xl font-bold text-gray-900">{stats.premiumPosts}</div>
              <div className="text-sm font-medium text-gray-600">Premium Posts</div>
            </div>
          )}
        </div>
      </div>
